...
export const KafkaAclApi: Record<string, ApiConfig> = {
  addKafkaUser: {
    url: '/user',
    method: 'post',
  },
...
export const KafkaConfigApi: Record<string, ApiConfig> = {
  getConfig: {
    url: '/config/console',
    method: 'get',
  },
...
export const KafkaTopicApi: Record<string, ApiConfig> = {
  getTopicNameList: {
    url: '/topic',
    method: 'get',
  },
...
export const KafkaConsumerApi: Record<string, ApiConfig> = {
...
export const KafkaClusterApi: Record<string, ApiConfig> = {
  getClusterInfo: {
    url: '/cluster',
    method: 'get',
  },
...
export const KafkaOpApi: Record<string, ApiConfig> = {
  syncConsumerOffset: {
...
export const KafkaMessageApi: Record<string, ApiConfig> = {
  searchByTime: {
...
export const KafkaClientQuotaApi: Record<string, ApiConfig> = {
...
export const UserManageApi: Record<string, ApiConfig> = {
  getPermissions: {
...
export const AuthApi: Record<string, ApiConfig> = {
  enable: {
    url: '/auth/enable',
    method: 'get',
  },
...
export const ClusterRoleRelationApi: Record<string, ApiConfig> = {
  select: {
